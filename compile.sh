...
#
#[2021-02-17] updated for mazer lab - just changed paths.
#             note: this generates a lot of errors..
...
#defaults for Linux
INCLMATLAB="/auto/share/matlab/extern/include/"
BINMATLAB="/auto/share/matlab/bin/"
